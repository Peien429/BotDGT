...
def parse_train_args(parser):
    ...
    parser.add_argument('--residual', type=bool, default=True, help='Use residual')
    ...
    parser.add_argument("--early_stop", type=bool, default=True, help="whether to use early stop or not")
